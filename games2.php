			...
			<div class="row">
				<div class="col-xl-7 col-lg-8 col-md-7">
                    ...
                    <?php
                        ...
                        // Loop to display game items with IDs from 1 to 9
                        for ($id = 10; $id <= 18; $id++) {

                        // Query the database for the game details using the current id
                        $result = mysqli_query($conn, "SELECT game_name, image_path, game_path FROM games WHERE game_id = $id");
                        $row = mysqli_fetch_assoc($result);
                    ?>

                    <div class="col-lg-4 col-md-6">
                        <div class="game-item">
                            <img src="<?php echo $row["image_path"]; ?>" alt="<?php echo $row["game_name"]; ?>">
					...
					<div class="site-pagination">
						<a href="games.php">01.</a>
						<a href="games2.php" class="active">02.</a>
						<a href="games3.php">03.</a>
					</div>
				</div>
