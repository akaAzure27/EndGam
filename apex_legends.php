...
$result = mysqli_query($conn, "SELECT game_price FROM price WHERE game_id = 10");
$row = mysqli_fetch_array($result);
$price = $row['game_price'];

$result2 = mysqli_query($conn, ("SELECT * FROM games where game_id = 10"));
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
                    ...
                    <button class="btn_game" name="btn_game">Add To Cart / <?php echo $price; ?></button>c<br>
					</form>

					<h4>About This Game</h4>
					<p>Conquer with character in Apex Legends, a free-to-play* Hero shooter where legendary characters with powerful abilities team up to battle for fame & fortune on the fringes of the Frontier.<br><br>

Master an ever-growing roster of diverse Legends, deep-tactical squad play, and bold, new innovations that go beyond the Battle Royale experience — all within a rugged world where anything goes. Welcome to the next evolution of Hero Shooter.</p>
