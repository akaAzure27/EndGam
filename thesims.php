...
$result = mysqli_query($conn, "SELECT game_price FROM price WHERE game_id = 21");
$row = mysqli_fetch_array($result);
$price = $row['game_price'];

$result2 = mysqli_query($conn, ("SELECT * FROM games where game_id = 21"));
