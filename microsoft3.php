		...
		<div class="container">
			<div class="row">
				<div class="col-xl-7 col-lg-8 col-md-7">
                    ...
                    WHERE platforms.platform_name = 'Microsoft Windows'  AND games.game_id >= 19
...
?>
					...
					<div class="site-pagination">
						<a href="Microsoft.php">01.</a>
						<a href="Microsoft2.php">02.</a>
                        <a href="Microsoft3.php" class="active">03.</a>
					</div>
				</div>
