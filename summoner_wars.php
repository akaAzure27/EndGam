...
$result = mysqli_query($conn, "SELECT game_price FROM price WHERE game_id = 4");
$row = mysqli_fetch_array($result);
$price = $row['game_price'];

$result2 = mysqli_query($conn, ("SELECT * FROM games where game_id = 4"));
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-xl-9 col-lg-8 col-md-7 game-single-content">
					...
					<p>Summoners War: Chronicles is an Action RPG that explores the conflicts and decisions that led to the state of the world (as seen in the original Summoners War: Sky Arena). You will play as one of three Summoners: Orbia, Kina, and Cleaf, as you explore the continents, Summon Monsters, and fight back the darkness that leaks through the Rift of Worlds..</p>
						...
						<div class="widget-item">
							<div class="testimonials-widget">
								...
								<div class="testim-text">
									<p>The King of Rahil is looking for a Summoner to protect the kingdom against Tefo's enormous conspiracy. Your story as a Rahil Guard begins now! Explore a vast world with your Summoned companions by your side in this new Action RPG set in the Summoners War Universe.</p>
