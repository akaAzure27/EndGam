		...
		<div class="container">
			<div class="row">
				<div class="col-xl-7 col-lg-8 col-md-7">
					<div class="row">
                    <?php
                    $result = mysqli_query($conn, "SELECT games.game_name, games.image_path, games.game_path, categories.category_name
                    FROM games
                    ...
                    WHERE categories.category_name = 'Simulation' AND games.game_id >= 25
...
?>
					...
					<div class="site-pagination">
						<a href="simulation.php">01.</a>
						<a href="simulation2.php" class="active">02.</a>
					</div>
				</div>
